...
class _LoginPageState extends State<LoginPage> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _navItem('NEWS', route: '/news'),
              const SizedBox(width: 32),
              _navItem('CALENDAR', route: '/calendar'),
  ...
  Widget _navItem(String label, {bool isActive = false, String? route}) {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const RoleLoginPage(role: 'student'),
                    ),
                  ),
                  style: ElevatedButton.styleFrom(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const RoleLoginPage(role: 'faculty'),
                    ),
                  ),
                  style: ElevatedButton.styleFrom(
