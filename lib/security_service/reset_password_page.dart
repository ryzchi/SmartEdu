    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text('Your password reset code:'),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFF0d2b5c).withOpacity(0.2)),
              ),
              child: Text(
                pin,
                    ...
                    children: [
                      Center(
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            const Text('Reset Password', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF1a2b4a))),
                            const SizedBox(height: 4),
                            Container(width: 40, height: 3, color: const Color(0xFFd4a843)),
                          ],
                        ),
                      ),
                      ...
                      if (_message != null)
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(_isSuccess ? Icons.check_circle_outline : Icons.error_outline,
                                  color: _isSuccess ? const Color(0xFF059669) : const Color(0xFFdc3545), size: 18),
                              const SizedBox(width: 8),
                              Expanded(child: Text(_message!, style: TextStyle(color: _isSuccess ? const Color(0xFF059669) : const Color(0xFFdc3545), fontSize: 13))),
                            ],
                          ),
                        ),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(6), borderSide: const BorderSide(color: Color(0xFF1a5276), width: 1.5)),
                      ...
                      Center(
                        child: TextButton(
                          onPressed: () => Navigator.pop(context),
                          child: const Text('← Back', style: TextStyle(color: Color(0xFF6c757d), fontSize: 13)),
                        ),
                      ),
                    ],
                  ),
